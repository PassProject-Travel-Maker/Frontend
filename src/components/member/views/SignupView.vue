...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md border border-gray-300 rounded-md p-10">
      <form @submit.prevent="join" class="space-y-6">
        <!-- ID -->
        <div>
          <label for="id" class="block text-sm font-medium leading-6 text-gray-900">ID</label>
          <div class="flex mt-2">
            <input v-model.trim="joinForm.id" id="id" name="id" type="text" required=""
            ...
            <button
              class="w-1/4 ml-2 py-1.5 bg-blue-500 text-white rounded-md shadow-sm hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              아이디 확인
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model.trim="joinForm.password" id="password" name="password" type="password"
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model.trim="joinForm.email" id="email" name="email" type="email" autocomplete="email" required=""
              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model.trim="joinForm.name" id="name" name="name" type="text" required=""
              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model.trim="joinForm.nickname" id="nickname" name="nickname" type="text" required=""
              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model.trim="joinForm.addr" id="addr" name="addr" type="text" required=""
              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
