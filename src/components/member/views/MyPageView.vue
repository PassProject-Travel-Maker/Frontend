...
#background::after {
  ...
  width: 200px;
  height: 200px;
  background-image: url("@/assets/images/others/bubble-1.png"),
    url("@/assets/images/others/bubble-2.png"), url("@/assets/images/others/bubble-3.png"),
    url("@/assets/images/others/bubble-4.png"), url("@/assets/images/others/bubble-5.png"),
